                    ...
                    <div className={styles.contentContainerList}>
                        <ul className={styles.contentItemsList}>
                            <li className={styles.contentItem}>
                                <a className={styles.contentItemPreview} href="">
                                    <img className={styles.contentItemPreviewImage} src={contentKnifePreview} alt="" width='374' height='295'/>
                                    <p className={styles.contentItemTitle}>Нож Лиса</p>
                                    <div className={styles.contentItemProperty}>
                                        <span className={styles.contentItemPropertySteal}>95x18</span>
                                    ...
                                    <div className={styles.contentItemUserOptions}>
                                        <p className={styles.contentItemPrice}>2719 p.</p>
                                        <div className={styles.contentItemUserOptionsContainer}>
                                            <button className={styles.contentItemCompare}>
                                                <img className={styles.contentItemCompareImage} width='26' src={compare} alt=""/>
                                            </button>
                                            <button className={styles.contentItemFavorite}>
                                                <svg className={styles.contenrItemFavoriteImage} width="28" height="27" viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
