...
const FilterSort: React.FC<PropsType> = ({sortCatalogByOption, setSortCatalogByOption}) => {
        ...
        <div className={styles.bodySort}>
            <button onClick={onSpoilerClick}
                ...
                ? 'По возрастанию цены' : sortCatalogByOption === 'price_down' ? 'По убыванию цены'
                    : ''}
                <svg className={`${styles.arrowButton} ${isSpoilerActive ? styles.arrowButtonRotated : ''}`}
                     width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.11323 9.2309L0.324654 2.00808C-0.107404 1.54862 -0.107404 0.803689 0.324655
                    0.344454C0.756329 -0.114819 1.45646 -0.114819 1.8881 0.344454L7.89495 6.73553L13.9016
                    0.34464C14.3334 -0.114632 15.0335 -0.114632 15.4652 0.34464C15.897 0.803913 15.897 1.54881
                    15.4652 2.00827L8.6765 9.23108C8.46056 9.46072 8.17784 9.57541 7.89498 9.57541C7.61199 9.57541
                    7.32906 9.4605 7.11323 9.2309Z" fill="#8a8a8a"/>
                </svg>
            </button>
