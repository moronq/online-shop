        ...
        <>
            ...
            {isCatalogActive &&
                <div className={styles.burgerMenuButtonBack} onClick={() => setIsCatalogActive(false)}>
                    <img src={arrowBack} className={styles.burgerMenuButtonSpanBackArrow} width="20" alt={'arrowBack'}/>
            ...
            <div className={`${styles.burgerMenu} ${isBurgerActive ? styles.burgerMenuActive : ''}`}>
                ...
                <div className={`${styles.burgerMenuContainer} ${isBurgerActive 
                            ...
                            <li onClick={onCatalogClick}
                                ...
                                <svg className={styles.burgerMenuItemStuffArrow} width="16" height="10"
                                    ...
                                    <path
                                        ...
                                        6.73553L13.9016 0.34464C14.3334 -0.114632 15.0335 -0.114632 15.4652
                                        0.34464C15.897 0.803913 15.897 1.54881 15.4652 2.00827L8.6765 9.23108C8.46056
                                        9.46072 8.17784 9.57541 7.89498 9.57541C7.61199 9.57541 7.32906 9.4605 7.11323
                                        9.2309Z" fill="white"/>
                                </svg>
                            </li>
